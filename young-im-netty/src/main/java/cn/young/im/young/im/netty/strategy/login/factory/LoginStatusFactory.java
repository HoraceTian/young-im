package cn.young.im.young.im.netty.strategy.login.factory;

import cn.young.im.common.enums.device.DeviceMultiLoginEnum;
import cn.young.im.common.model.user.UserClientDTO;
import cn.young.im.young.im.netty.strategy.login.LoginContext;
import cn.young.im.young.im.netty.strategy.login.LoginStatus;
import cn.young.im.young.im.netty.strategy.login.impl.AllClientLoginStatus;
import cn.young.im.young.im.netty.strategy.login.impl.OneClientLoginStatus;
import cn.young.im.young.im.netty.strategy.login.impl.ThreeClientLoginStatus;
import cn.young.im.young.im.netty.strategy.login.impl.TwoClientLoginStatus;
