package cn.young.im.common.util;
...
public class DateUtil {
     ...
     * @return 无无符号的当前时间
     */
    public static String getUnsignedDatetimeStr() {
     ...
     * 根据输入的毫秒值自动转换为合适的单位
     *
     * @param milliseconds 需要转换的毫秒值
     * @return 正确合适的单位
     */
    public static String convertToMaxPrecision(long milliseconds) {
